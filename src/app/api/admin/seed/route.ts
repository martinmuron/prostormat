...
export async function POST(request: Request) {
  try {
    ...
    // If forceReset is true, delete all data first
    if (forceReset) {
      console.log('Force reset requested - deleting all data...')
    ...
    const venues = [
      ...
      },
      {
        ...
        description: 'Prestižní střešní terasa v srdci Prahy s úžasným výhledem.',
      ...
      },
      {
        name: 'Ribs of Prague',
        slug: 'ribs-of-prague',
        description: 'Stylová restaurace se zaměřením na grilovaná masa a americkou kuchyni.',
        address: 'Újezd 19, Praha 1',
        capacitySeated: 65,
        capacityStanding: 95,
        venueType: 'restaurant',
