    ...
    const result = await db.$transaction(async (tx) => {
      ...
      const venue = await tx.prostormat_venues.create({
        data: {
          ...
          capacitySeated: validatedData.capacitySeated ? String(validatedData.capacitySeated) : null,
          capacityStanding: validatedData.capacityStanding ? String(validatedData.capacityStanding) : null,
