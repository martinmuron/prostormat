    ...
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="relative py-24 px-6 bg-white border-b border-gray-200 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/3 right-1/3 w-64 h-64 bg-purple-100/40 rounded-full blur-3xl animate-float-medium"></div>
          <div className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-pink-100/40 rounded-full blur-3xl animate-float-fast"></div>
        </div>
