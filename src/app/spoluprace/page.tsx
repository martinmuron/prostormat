...
export default function SpolupracePage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Problem Statement */}
      <section className="py-16 sm:py-12 px-4 sm:px-6 bg-gray-50 border-b border-gray-200">
        <div className="max-w-4xl mx-auto text-center">
          <ScrollReveal>
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed">
              Hledání nových klientů pro váš event prostor je náročné. Reklama je drahá, výsledky nejisté.
            </p>
            <p className="text-lg sm:text-xl text-gray-900 mt-6 font-semibold leading-relaxed">
